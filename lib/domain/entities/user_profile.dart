...
class UserProfile {
  ...
  const UserProfile({
    ...
    this.name = 'Athlete',
    this.avatarUrl = 'assets/images/avatars/avatar_smash_pro.jpg',
    this.dateOfBirth,
    this.gender,
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    ...
    return UserProfile(
      ...
      avatarUrl: (json['avatarUrl'] == null || json['avatarUrl'] == 'assets/images/logo.png' || !json['avatarUrl'].toString().contains('avatars'))
